            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    for (int k=0; k< fixedTime.length;  k++){
                        ...
                        {
                            if (reservations.get(i).getData().equals(selectedDate) && reservations.get(i).getZoneName().equals(zoneName) && !"canceled".equals(reservations.get(i).getStatus())){
